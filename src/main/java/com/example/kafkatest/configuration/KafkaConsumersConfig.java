...
public class KafkaConsumersConfig {
    ...
    @Bean
    public <T> ConsumerFactory<String, T> genericKafkaConsumerFactory(KafkaConsumerProperties properties, Class<T> classType) {
        Map<String, Object> configMap = new HashMap<>();
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, ChatMessageKafkaDTO> kafkaListenerContainerFactoryForKVSW(KafkaConsumerProperties properties) {
    ...
    @Bean
    public ConsumerFactory<Long, TrendingArticles> genericAvroRecordKafkaConsumerFactory(KafkaConsumerProperties properties) {
        Map<String, Object> configMap = new HashMap<>();
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<Long, TrendingArticles> kafkaListenerContainerFactoryForTrendingArticles(KafkaConsumerProperties properties) {
